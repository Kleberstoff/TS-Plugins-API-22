...
const char* ts3plugin_description()
{
	...
	return "I wanna stay right here.\nFor more Plugins check out: https://r4p3.net/forums/plugins.68/";
}
...
void ts3plugin_registerPluginID(const char* id)
{
	...
	printf("Anti-Move: registerPluginID: %s\n", pluginID);
}
...
{
	printf("Anti-Move: onMenuItemEvent: serverConnectionHandlerID=%llu, type=%d, menuItemID=%d, selectedItemID=%llu\n", (long long unsigned int)serverConnectionHandlerID, type, menuItemID, (long long unsigned int)selectedItemID);
	switch (menuItemID)
	{
